...
const DryingPreset* defaultPresets(size_t& count) {
  static const DryingPreset presets[] = {
      {"pla", "PLA", 45.0f, 20.0f, 6UL * 3600UL, 95.0f, {25, 100, 15, 90, 900, 30}},
      {"petg", "PETG", 55.0f, 20.0f, 6UL * 3600UL, 100.0f, {25, 100, 15, 90, 600, 30}},
      {"abs", "ABS/ASA", 65.0f, 15.0f, 6UL * 3600UL, 105.0f, {30, 100, 15, 90, 600, 45}},
      {"tpu", "TPU", 50.0f, 15.0f, 8UL * 3600UL, 100.0f, {25, 100, 15, 90, 900, 30}},
      {"pa", "PA/Nylon", 70.0f, 10.0f, 8UL * 3600UL, 105.0f, {35, 100, 15, 90, 450, 60}},
      {"pc", "PC (experimental)", 75.0f, 10.0f, 8UL * 3600UL, 105.0f, {40, 100, 15, 90, 300, 60}},
  };
